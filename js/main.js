...
function setCustomEffects() {
    ...
    timeless.getEffect = function () {
        return 1 + (timeless.isHero ? 2 : 1.5) ** (getBaseLog(timeless.isHero ? 5 : 10, timeless.level ** 0.8 + 1))
   }
...
function getHappiness() {
    ...
    const happiness = godsBlessings * meditationEffect() * kittenEffect() * butlerEffect() * mindreleaseEffect()
